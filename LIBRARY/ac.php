...
$sql="SELECT count(sid) AS count FROM allocation WHERE status='f' AND type='AC' ";
...
if(isset($_SESSION['totcnt'])){
  ...
  $sql="UPDATE allocation SET status='o' WHERE sid='".$sid."' AND type='AC'";
...
if(isset($_SESSION['totcnt'])){
  ...
  $sql="UPDATE allocation SET status='f' WHERE sid='".$sid."' AND type='AC' ";
